...
## About Waves
Waves is a decentralized platform that allows any user to issue, transfer, swap and trade custom blockchain tokens on an integrated peer-to-peer exchange. You can find more information about Waves at [waves.tech](https://waves.tech/) and in the official [documentation](https://decentralchain.io/documentacion).
...
## Prerequisites
It is highly recommended to read more about [Waves Node configuration](https://decentralchain.io/documentacion/en/waves-node/node-configuration) before running the container.
...
|`WAVES_LOG_LEVEL`     | `DEBUG`           | Default Waves Node log level. Available values: `OFF`, `ERROR`, `WARN`, `INFO`, `DEBUG`, `TRACE`. More details about logging are available [here](https://decentralchain.io/documentacion/en/waves-node/logging-configuration). Can be overridden in a runtime using environment variable with the same name. |
...
| `WAVES_LOG_LEVEL`                 | Node logging level. Available values: `OFF`, `ERROR`, `WARN`, `INFO`, `DEBUG`, `TRACE`. More details about logging are available [here](https://decentralchain.io/documentacion/en/waves-node/logging-configuration).|
...
1. REST-API interaction with Node. Details are available [here](https://decentralchain.io/documentacion/en/waves-node/node-configuration#rest-api-settings).

2. Waves Node communication port for incoming connections. Details are available [here](https://decentralchain.io/documentacion/en/waves-node/node-configuration#network-settings).
